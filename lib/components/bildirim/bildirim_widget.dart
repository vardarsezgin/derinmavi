...
class BildirimWidget extends StatefulWidget {
  ...
  @override
  _BildirimWidgetState createState() => _BildirimWidgetState();
}

class _BildirimWidgetState extends State<BildirimWidget> {
  late BildirimModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BildirimModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: StreamBuilder<NotificationsRecord>(
        stream: NotificationsRecord.getDocument(widget.notId!),
        builder: (context, snapshot) {
          ...
          return InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('BILDIRIM_COMP_Container_kt6n1ff4_ON_TAP');
            ...
            child: ClipRRect(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: containerNotificationsRecord.isReaded == false
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                mainAxisSize: MainAxisSize.max,
                                                children: [
                                                  if (containerNotificationsRecord
                                                              .notText !=
                                                          null &&
                                                      containerNotificationsRecord
                                                              .notText !=
                                              ...
                                              if (containerNotificationsRecord
                                                ...
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'BILDIRIM_COMP_Image_3lmpyelg_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_expand_image');
