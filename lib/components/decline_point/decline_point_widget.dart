...
import 'decline_point_model.dart';
export 'decline_point_model.dart';

class DeclinePointWidget extends StatefulWidget {
  const DeclinePointWidget({
    Key? key,
  ...
  @override
  _DeclinePointWidgetState createState() => _DeclinePointWidgetState();
}

class _DeclinePointWidgetState extends State<DeclinePointWidget> {
  late DeclinePointModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeclinePointModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'DECLINE_POINT_COMP_replaceWidget_ON_TAP');
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('DECLINE_POINT_COMP_component_ON_TAP');
                        ...
                        await dropdown8OptionsDivePointsRecord.reference
                            .update(createDivePointsRecordData(
                          isDeclined: true,
                        ));
