...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF037EF1);
  late Color secondary = const Color(0xFF0148D4);
  late Color tertiary = const Color(0xFFFFD991);
  late Color alternate = const Color(0xFFE8F3FF);
  ...
  late Color accent4 = const Color(0xEEEEEEEE);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xAB24282A);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFFFFFEFB);
