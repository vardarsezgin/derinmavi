...
class _RegisterPageWidgetState extends State<RegisterPageWidget>
  ...
  void initState() {
    ...
    _model.mailAddressController ??= TextEditingController();
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'REGISTER_PAGE_PAGE_Text_xgyg2owt_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Text_send_email');
                                                      await launchUrl(Uri(
                                                          scheme: 'mailto',
                                                        ...
                                                        child: TextFormField(
                                                          ...
                                                          keyboardType:
                                                              TextInputType
                                                                  .emailAddress,
                                                          validator: _model
                                                              .mailAddressControllerValidator
                                                              .asValidator(
                                                                  context),
                                                        ),
                                                      ),
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'REGISTER_PAGE_PAGE_Text_8dnyfavd_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Text_navigate_to');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'REGISTER_HESABI_OLUŞTUR_BTN_ON_TAP');
                                              logFirebaseEvent(
                                            ...
                                            child: Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'REGISTER_PAGE_PAGE_apple_ICN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'IconButton_auth');
                                                    GoRouter.of(context)
                                                        .prepareAuthEvent();
                                            ...
                                            child: Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'REGISTER_PAGE_PAGE_phone_ICN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'IconButton_navigate_to');
