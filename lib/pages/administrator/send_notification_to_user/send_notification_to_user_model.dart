...
import 'send_notification_to_user_widget.dart'
    show SendNotificationToUserWidget;
...
class SendNotificationToUserModel
    extends FlutterFlowModel<SendNotificationToUserWidget> {
  ...
  String? _notNameControllerValidator(BuildContext context, String? val) {
    ...
    if (val.length > 70) {
      return 'Maksimum 70 karakter girilmelidir.';
    }
  ...
  String? _nottextControllerValidator(BuildContext context, String? val) {
    ...
    if (val.length > 256) {
      return 'Maksimum 256 karakter girilmelidir.';
    }
