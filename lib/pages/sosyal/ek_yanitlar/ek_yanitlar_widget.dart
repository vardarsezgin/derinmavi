...
import 'ek_yanitlar_model.dart';
export 'ek_yanitlar_model.dart';

class EkYanitlarWidget extends StatefulWidget {
  const EkYanitlarWidget({
    Key? key,
  ...
  @override
  _EkYanitlarWidgetState createState() => _EkYanitlarWidgetState();
}

class _EkYanitlarWidgetState extends State<EkYanitlarWidget> {
  late EkYanitlarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EkYanitlarModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<TestForumRepliesRecord>(
                          ...
                          children: [
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'EK_YANITLAR_COMP_Stack_r3glisof_ON_TAP');
                                  if (containerTestForumRepliesRecord
                                          .replyUser ==
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EK_YANITLAR_COMP_Text_klpcs1qo_ON_TAP');
                                          if (containerTestForumRepliesRecord
                                                  .replyUser ==
                                              currentUserReference) {
                                            logFirebaseEvent(
                                ...
                                if (containerTestForumRepliesRecord
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EK_YANITLAR_COMP_Image_a1on7t9z_ON_TAP');
                                      ...
                                      child: Hero(
                                        tag: containerTestForumRepliesRecord
                                            .replyPhoto,
                              ...
                              children: [
                                ToggleIcon(
                                  onPressed: () async {
                                    ...
                                    final likedByUpdate =
                                        containerTestForumRepliesRecord.likedBy
                                    ...
                                    logFirebaseEvent(
                                        'EK_YANITLAR_ToggleIcon_ivxy860j_ON_TOGGL');
                                    if (!containerTestForumRepliesRecord.likedBy
                                      ...
                                      await NotificationsRecord.collection
                                        ...
                                        ...createNotificationsRecordData(
                                          ...
                                          isReaded: false,
                                          alici: containerTestForumRepliesRecord
                                              .replyUser,
                                  ...
                                  value: containerTestForumRepliesRecord.likedBy
                                      .contains(currentUserReference),
                                  onIcon: Icon(
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EK_YANITLAR_COMP_Text_qb06lxi9_ON_TAP');
                                    if (containerTestForumRepliesRecord
                                            .likedBy.length >
                                        0) {
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              dateTimeFormat(
                                'relative',
                                containerTestForumRepliesRecord.timeReplied!,
                                locale:
                            ...
                            if ((currentUserReference ==
                              ...
                              AuthUserStreamWidget(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EK_YANITLAR_COMP_SideButton_ON_TAP');
