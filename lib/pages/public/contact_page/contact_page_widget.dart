                ...
                child: Row(
                  ...
                  children: [
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'CONTACT_arrow_back_rounded_ICN_ON_TAP');
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(35.0, 30.0, 35.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: SelectionArea(
                                child: Text(
                              'buradan bize destek olabilirsin :)',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(35.0, 5.0, 35.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CONTACT_Container_ml3lvxm2_ON_TAP');
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CONTACT_E_POSTA_GÖNDER_BTN_ON_TAP');
                              logFirebaseEvent('Button_send_email');
                              await launchUrl(Uri(
                                  scheme: 'mailto',
                                  path: 'derinmavi@sezginvardar.com',
                                  query: {
                                    'subject': 'derinmavi İletişim Formu',
                                  }
                                      .entries
