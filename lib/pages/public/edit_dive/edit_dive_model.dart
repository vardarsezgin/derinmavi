...
import 'dart:io';
import 'edit_dive_widget.dart' show EditDiveWidget;
...
class EditDiveModel extends FlutterFlowModel<EditDiveWidget> {
  ...
  String? _diveTempControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Zorunlu';
    }
  ...
  String? _airConsumptionControllerValidator(
  ...
  String? _secDepthControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Zorunlu';
    }
  ...
  String? _secDurationControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Zorunlu';
    }
  ...
  void initState(BuildContext context) {
    ...
    diveTempControllerValidator = _diveTempControllerValidator;
    airConsumptionControllerValidator = _airConsumptionControllerValidator;
    secDepthControllerValidator = _secDepthControllerValidator;
    secDurationControllerValidator = _secDurationControllerValidator;
  }
